...
import com.example.medplusadmin.utils.convertMedicineObject
...
class MedicinesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
                    ...
                    medicineCLick.delete -> {
                        AlertDialog.Builder(mainActivity).apply {
                            ...
                            setPositiveButton("Delete") { _, _ ->
                                db.collection(MEDICINE).document(model.medId!!).delete()
        ...
        db.collection(MEDICINE).addSnapshotListener { snapshots, e ->
            if (e != null) {
    ...
    private fun getIndex(model: Medicine): Int {
