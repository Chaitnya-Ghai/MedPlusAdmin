 ...
 * Use the [ShowSingleMedicineFragment.newInstance] factory method to
...
class ShowSingleMedicineFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ShowSingleMedicineFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ShowSingleMedicineFragment().apply {
